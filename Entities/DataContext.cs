...
namespace Entities
{
    public partial class DataContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=capstone.ctbufelmyc0l.ap-southeast-1.rds.amazonaws.com;Database=BadmintonDB1;user id=admin;password=be123456;Trusted_Connection=False");
            }
        }
